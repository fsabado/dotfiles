...
#download all dependencies required to build to your local maven repository;
#subsequent builds can now be run in "offline" mode or from systems that cannot access the Artifactory server or the internet
alias mvn-offline="mvn -fae -nsu dependency:go-offline"
#download sources of dependencies (if available);
